...
class fcaIntroducer{
  ...
  public function sendMail()
  {
    $headers  	= 	'MIME-Version: 1.0' . "\n";
  	...
  	$headers 	.= 	'From: Gas Elec Administration <hpf@gas-elec.co.uk>'. "\n";
  	$headers 	.=	'Reply-To: Gas Elec Administration <hpf@gas-elec.co.uk>' . "\n" .
     					'X-Mailer: PHP/' . phpversion();
    mail('daniel@gas-elec.co.uk', "HPF introducer", $this->emailTemplate(), $headers);
    mail('hpf@gas-elec.co.uk', "HPF introducer", $this->emailTemplate(), $headers);
  }
  ...
  public function email()
  {
      $array = array(
        ...
        'content' => '
        <p>Please fill in your email to gain access to the HPF Introducer portal</p>
  ...
  public function slide1()
  {
    $array = array(
      ...
      'content' => '<img src="http://www.gas-elec.co.uk/image/HPFLogo.jpg" align="right" alt="Home Project Finance Logo" /><p>Welcome to our Home Project Finance (HPF). This is a trading name under gas elec safety systems limited and thank you for reading and taking part in this training presentation.</p>
      ...
      <p>
        We will familiarise you with certain areas of the finance industry and help you to understand your role and how important it is to treat customers fairly and ensure finance is sold correctly. Our aim in producing this training presentation is to break down key areas into easy to understand sections and to support your practices when working with us to ensure at all times you recognise and meet the FCA Requirements.
      </p>
      ...
      <p>
        The role of the Financial Conduct Authority is to:
      </p>
      ...
      <p>
        Our firm is authorised and regulated by the Financial Conduct Authority; this has been a long and complicated process taking around 8 months to complete with many detailed questions asked during this time including checking the fitness and suitability of the directors and shareholders.
      </p>
  ...
  public function slide2()
  {
    $array = array(
      ...
      'content' => '<img src="http://www.gas-elec.co.uk/image/HPFLogo.jpg" align="right" alt="Home Project Finance Logo" />
  ...
  public function slide4()
  {
    $array = array(
      ...
      'content' => '<img src="http://www.gas-elec.co.uk/image/HPFLogo.jpg" align="right" alt="Home Project Finance Logo" />
      <p>This is called “a claim under section 75 of the Consumer Credit Act”.
      </p>
  ...
  public function slide14()
  {
    $array = array(
      ...
      <p><strong>If you have any other questions or need any other support. please call 01895 420 777 or email <a href="mailto:GreenDeal@gas-elec.co.uk">GreenDeal@gas-elec.co.uk</a></strong></p>
  			...
  			<tr>
  				<td>
  					<table align="center" border="0" cellpadding="0" cellspacing="0" style="background: #fff;" width="690">
  						<tr>
  							<td>
  								<a border="0px" href="http://www.gas-elec.co.uk/Forward/12"><img border="0px" src="http://www.gas-elec.co.uk/Newsletters/newboilerorhomeimprovement/Images/head.jpg"></a>
  							</td>
  						</tr>
